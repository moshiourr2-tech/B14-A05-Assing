      ...
      <div className="mx-auto flex min-h-155 max-w-7xl items-center justify-between px-1 py-16 flex-col md:flex-row">
        <div className="w-full max-w-xl text-center md:text-left">
          ...
          <div className="mt-8 flex items-center justify-center gap-5 md:justify-start">
            <button className="rounded-md bg-linear-to-r from-orange-400 to-pink-500 px-5 py-3 text-sm font-medium text-white shadow-md transition hover:opacity-90">
              Explore Technologies
            </button>

            <button className="rounded-2xl border border-gray-200 bg-white px-12 py-4 text-base font-medium text-gray-800">
              Learn More
            </button>
          </div>
        </div>
