...
//       <div className="mx-auto flex min-h-125 max-w-6xl items-center justify-between px-7 py-10">
//         {/* Left Content */}
...
//             <button
//               className="rounded-md bg-linear-to-r from-orange-400 to-pink-500
//               px-5 py-3 text-sm font-medium text-white shadow-md
...
//             <button
//               className="px-5 py-3 text-sm font-medium text-gray-500
      ...
      <div className="mx-auto flex min-h-155 max-w-7xl items-center justify-between px-1 py-16 flex-col md:flex-row">
        ...
        <div className="w-full max-w-xl text-center md:text-left">
          ...
          <div className="mt-8 flex items-center justify-center gap-5 md:justify-start">
            ...
            <button
              className="rounded-md bg-gradient-to-r from-orange-400 to-pink-500 px-5 py-3 text-sm font-medium text-white shadow-md transition hover:opacity-90">
              Explore Technologies
            </button>
